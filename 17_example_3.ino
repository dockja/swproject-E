...
#define PIN_IR    5        // IR sensor at Pin A0
#define PIN_LED   9
#define PIN_SERVO 10
...
#define LOOP_INTERVAL 15   // Loop Interval (unit: msec)
...
void loop()
{
  ...
  duty = _DUTY_MIN + percentage * (_DUTY_MAX - _DUTY_MIN); // Put map() equivalent code here
